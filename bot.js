...
if(message.content.toLowerCase() === prefix + "photoshop"){
    ...
    if(message.content.toLowerCase() === prefix + "adminhelp"){
        ...
        .addField("`" + prefix + 'kick (user) (reason)`', "Kick a user for their bad behaviour. **(ADMIN ONLY)**")
        .addField("`" + prefix + 'ban (user) (reason)`', "Ban a user for their bad behaviour. **(ADMIN ONLY)**")
        .addField("`" + prefix + 'clear (amount)`', "Clear the amount of messages specified. **(ADMIN ONLY)**")
